...
stripe-cancellation-deletion-candidate-trigger-design.md(フェーズ91)の削除候補洗い出し
ロジックの仕様に沿った挙動を確認する。"""
...
_EVENT_TIME = datetime(2026, 8, 22, 12, 0, 0)
...
class ClearDeletionCandidateOnSubscriptionReactivatedTest(unittest.TestCase):
    ...
    def test_first_time_subscription_created_is_a_harmless_no_op(self):
        # design 4節: 「初回契約」でも`customer.subscription.created`は発火しうるが、
