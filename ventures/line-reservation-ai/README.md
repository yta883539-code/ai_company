...
- llm-system-prompt-draft.md: 会話フロー・二重予約防止・トーン&マナー・保留タイムアウト・無断キャンセル対応等の既存設計を統合した、LLM会話エンジン向けシステムプロンプト草案(2026-07-30 17:58 UTC更新、雑談・スパム入力[厳守事項9]・未実装機能問い合わせ[厳守事項10]への対応を追加。実装・動作検証は未着手)
...
- llm-system-prompt-draft.mdの厳守事項9a説明文に、owner-settings-wireframe.mdへ追加した店舗FAQ情報入力欄(住所・アクセス/駐車場/支払い方法)を反映する
