...
## 次にやること(候補)
- 実際の初回コンタクト依頼文面の草案作成(オーナー承認後に使う想定、文面自体は事前準備してよいか要検討)
