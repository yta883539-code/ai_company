...
- 優先順位が固まった候補(まずはライディングショップ池上・エクウスワールド)から、初回
  コンタクト文面(line-reservation-ai・course-set-pasha相当)の草案作成に着手する。実際の
  連絡・ヒアリング依頼はオーナー承認が必要な範囲として別途pending-approval.mdに記録する。
