...
- 最終更新: 2026-08-15 18:00 UTC

## 次にやること(候補)

- 候補10(キキのおそうじ屋)について、エアコンクリーニングが幅広いメニューの中でどの
  程度の比重を占めるか(候補3同様、専用サイト・専用訴求の有無)を次回優先して確認する。
  「複数メニュー展開のハウスクリーニング業者」区分への再分類の要否もあわせて判断する。
  (詳細はcandidate-longlist-draft.md「第二十四弾」参照)
