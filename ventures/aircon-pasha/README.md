...
- フェーズ61(2026-08-16 23:01 UTC): 「次にやること」だった、「個人のSNS発信・ブログ経由」の
  ...
  「第三十七弾」参照。
- 最終更新: 2026-08-16 23:01 UTC

## 次にやること(候補)

- フランチャイズ加盟系の正式候補が候補2・13の2件のまま目標件数(3〜4件)の下限を
  割り込んでいる。「個人のSNS発信・ブログ経由」のキーワード探索がフェーズ61で3クエリとも
  空振りに終わったため、次回はInstagram・X等のハッシュタグ検索や、ミツモア・くらしの
  マーケット等の個人事業主向けポータルの事業者プロフィール個別ページ経由での探索に
  切り替える。(詳細は上記フェーズ61・candidate-longlist-draft.md「第三十七弾」参照)
